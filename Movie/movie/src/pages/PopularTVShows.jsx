...
import { Card, Skeleton, Select, Input, Button } from 'antd';
...
const PopularTVShows = () => {
    ...
    const fetchTVShows = async () => {
      try {
        ...
        const response = await axios.get(
          `https://api.themoviedb.org/3/tv/popular?api_key=3126672c16d21f8a4e4bd93c162f803e&language=en-US&sort_by=${sortOption}&page=${page}`
        );
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      <h1 className="text-4xl font-bold text-center mb-6 text-[#032541]">Popular TV Shows</h1>
        ...
        {loading && page === 1
          ...
          : filteredTVShows.map((tvShow) => (
              <Card
                ...
                onClick={() => navigate(`/tv-show/${tvShow.id}`)}
              >
                <Meta
                  title={tvShow.name}
                  description={
