...
const TopRatedTVShows = () => {
    ...
    const fetchTVShows = async () => {
      try {
        ...
        const response = await axios.get(
          `https://api.themoviedb.org/3/tv/top_rated?api_key=3126672c16d21f8a4e4bd93c162f803e&language=en-US&page=${page}`
        );
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      <h1 className="text-4xl font-bold text-center mb-6 text-[#032541]">Top Rated TV Shows</h1>
